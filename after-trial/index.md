...
1.  **運営からの情報受領**
    1.  カルステップ運営から、正式版のAPI情報を記載したパスワード付きExcelファイルがメールで届きます。
...
アップデートは、新しいバージョンを **ZIPファイル** で配布しています。ダウンロードサイトからZIPを取得して解凍すれば、新規利用時と同様に利用できます。
